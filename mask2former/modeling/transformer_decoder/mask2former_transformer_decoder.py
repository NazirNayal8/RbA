...
class BNReluConv(nn.Sequential):
    ...
    def forward(self, *inputs):
        ...
        return super(BNReluConv, self).forward(inputs)
...
class MultiScaleMaskedTransformerDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        ood_prediction, # for DenseHybrid Loss
        ...
        self.ood_prediction = ood_prediction
        ...
        if self.ood_prediction:
            self.ood_pred = BNReluConv(hidden_dim, 2, k=1, bias=True)
    ...
    def from_config(cls, cfg, in_channels, mask_classification):
        ...
        ret["ood_prediction"] = cfg.MODEL.MASK_FORMER.DENSE_HYBRID_LOSS
    ...
    def forward(self, x, mask_features, mask = None):
        ...
        if self.ood_prediction:
            out['ood_pred'] = self.ood_pred(mask_features)
...
@TRANSFORMER_DECODER_REGISTRY.register()
class MultiScalePerPixelDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        assert not mask_classification, "Only support per pixel model"
        self.mask_classification = mask_classification
